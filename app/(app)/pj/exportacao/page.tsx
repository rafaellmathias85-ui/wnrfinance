    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">Baixe relatórios em formato CSV para uso em planilhas</p>
        </div>
      </div>

      {/* Date filter */}
      <div className="bg-card border border-border rounded-xl p-4">
        <p className="text-muted-foreground text-sm font-medium mb-3">Filtro de período (opcional)</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {ENTITIES.map(e => {
          ...
          return (
            <div key={e.value} className="bg-card border border-border rounded-xl p-5 space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center flex-shrink-0">
                  <Icon className="w-5 h-5 text-foreground" />
                </div>
                <div>
                  <p className="text-foreground font-medium">{e.label}</p>
                  <p className="text-muted-foreground text-xs mt-0.5">{e.description}</p>
                  {!e.hasDateFilter && (
                    <p className="text-muted-foreground text-xs mt-1">Exporta todos os registros</p>
                  )}
                </div>
              </div>
              <button
                ...
                disabled={isLoading}
                className="w-full flex items-center justify-center gap-2 bg-muted hover:bg-muted text-foreground py-2 rounded-lg text-sm transition-colors disabled:opacity-60"
              >
      ...
      <div className="bg-card/50 border border-border rounded-xl p-4">
        <p className="text-muted-foreground text-sm font-medium mb-1">Sobre os arquivos CSV</p>
